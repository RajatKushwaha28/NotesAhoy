...
<div class = "container">
  	...
  	<br>
  	<h1 class="tec=xt-uppercase">Publish Notes</h1>
  	<div class="row">
  	<div class="col-12">
  	<%
  		...
  		List<Note> L = nd.getPublishable(email);
  		for(Note note : L)
  		{
  			%>
  			<div class="card mt-3">
  <img class="card-img-top m-4 mx-auto " style="max-width:100px;"src="icons/publishNote.svg" class="card-img-top" alt="...">
